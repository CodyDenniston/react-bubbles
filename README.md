...
Use a login page that authorizes a token when a user puts in the correct username and password. Use a private route for the sensetive data

- [ ] Describe how web servers work.

A web server is a computer made to store code for websites to be shared across the world. This is referred to as hosting
